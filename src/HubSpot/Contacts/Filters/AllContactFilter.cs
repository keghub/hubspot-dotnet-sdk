...
namespace HubSpot.Contacts.Filters {
    public class AllContactFilter : ContactFilter
    {
        ...
        {
            var response = await client.Contacts.GetAllAsync(propertiesToQuery, PropertyMode.ValueOnly, FormSubmissionMode.None, false, 25, offset).ConfigureAwait(false);
