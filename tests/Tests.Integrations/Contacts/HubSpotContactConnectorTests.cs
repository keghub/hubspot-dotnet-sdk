    ...
    public class HubSpotContactConnectorTests
    {
        ...
        private HubSpotContactConnector CreateSystemUnderTest()
        {
            var registrations = new[]
            {
                ...
                new TypeConverterRegistration { Converter = new LongTypeConverter(), Type = typeof(long?) },
                new TypeConverterRegistration { Converter = new DateTimeOffSetConverter(), Type = typeof(DateTimeOffset) },
                new TypeConverterRegistration { Converter = new DateTimeOffSetConverter(), Type = typeof(DateTimeOffset?) },
                new TypeConverterRegistration { Converter = new DateTimeConverter(), Type = typeof(DateTime) },
                new TypeConverterRegistration { Converter = new DateTimeConverter(), Type = typeof(DateTime?) },
